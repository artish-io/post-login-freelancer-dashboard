...
import PayInvoiceClientActions from '../../../../../../components/commissioner-dashboard/projects-and-invoices/invoices/pay-invoice-client-actions';
    ...
    <div className="w-full max-w-6xl mx-auto px-6 lg:px-12 pt-4 pb-12">
      ...
      <div className="mt-6 mb-4">
        <nav className="flex items-center space-x-2 text-sm text-gray-600">
          ...
          <span>›</span>
          <span className="text-gray-900 font-medium">Pay Invoice</span>
        </nav>
      </div>
