...
export default function CommissionerProductInventoryPage() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        const res = await fetch('/api/storefront/commissioner-products');
  ...
  return (
    <section className="flex flex-col gap-6 px-6 py-6">
        {/* Page header */}
        <StoreDataNavigation currentPage="sales" dashboardType="commissioner" />
