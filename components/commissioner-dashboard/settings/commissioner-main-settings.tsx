...
import { ArrowLeft, ChevronRight, User, CreditCard, HelpCircle, LogOut, Settings } from 'lucide-react';
import AccountSettings from '../../freelancer-dashboard/settings/account-settings';
import ContactHelp from '../../freelancer-dashboard/settings/contact-help';

type SettingsPage = 'main' | 'account' | 'payments' | 'preferences' | 'help';
...
export default function CommissionerMainSettings() {
